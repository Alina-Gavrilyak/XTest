...
namespace XTest.ElseCodeAndLabs.BergerCode
{
    public partial class FormBergerTest1 : MetroForm
    {
        ...
        public FormBergerTest1(bool isTest, bool codec)
        {
            InitializeComponent();
        ...
        {
            Random r = new Random();
            BergerData data = new BergerData();
        ...
        private void BtnNext_Click(object sender, EventArgs e)
        {
            if (_isTest)
            {
                ...
                {
                    FormBergerTest1 form = new FormBergerTest1(true, _codec);
                    form.Show();
                    this.Close();
                }
                else
            ...
            {
                FormBergerTest1 form = new FormBergerTest1(false, _codec);
                form.Show();
                this.Close();
            }
        }
