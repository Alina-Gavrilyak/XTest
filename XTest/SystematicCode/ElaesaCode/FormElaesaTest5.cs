...
{
    public partial class FormElaesaTest5 : MetroForm
    {
        ...
        public FormElaesaTest5(bool isTest, int correctAnswers = 0)
        {
            if (correctAnswers != 0)
        ...
        private void FillFormData()
        {
            ...
            matrixTextBox1.Text = keys[0];
            matrixTextBox2.Text = keys[1];
            matrixTextBox3.Text = keys[2];
            matrixTextBox4.Text = keys[3];
            matrixTextBox5.Text = keys[4];
            matrixTextBox6.Text = keys[5];
            matrixTextBox7.Text = keys[6];
            matrixTextBox8.Text = keys[7];
            matrixTextBox9.Text = keys[8];
            matrixTextBox10.Text = keys[9];
            matrixTextBox11.Text = keys[10];
            matrixTextBox12.Text = keys[11];
            matrixTextBox13.Text = keys[12];
            matrixTextBox14.Text = keys[13];
            matrixTextBox15.Text = keys[14];
            matrixTextBox16.Text = keys[15];
            matrixTextBox17.Text = keys[16];
            matrixTextBox18.Text = keys[17];
            matrixTextBox19.Text = keys[18];
            matrixTextBox20.Text = keys[19];
            matrixTextBox21.Text = keys[20];
            matrixTextBox22.Text = keys[21];
            matrixTextBox23.Text = keys[22];
            matrixTextBox24.Text = keys[23];
            matrixTextBox25.Text = keys[24];
            matrixLabel1.Text = keys[25];
