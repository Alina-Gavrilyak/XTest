...
{
    public partial class FormRida_MilleraTest1 : MetroForm
    {
        ...
        public FormRida_MilleraTest1(bool isTest)
        {
            InitializeComponent();
        ...
        private void FillFormData()
        {
            ...
            label177.Text = item.Key[0];
            label178.Text = item.Key[1];
            label179.Text = item.Key[2];
            label180.Text = item.Key[3];
            label181.Text = item.Key[4];
            label182.Text = item.Key[5];
            label183.Text = item.Key[6];
            label184.Text = item.Key[7];
            label185.Text = item.Key[8];
            label186.Text = item.Key[9];
            label187.Text = item.Key[10];
        ...
        private void BtnNext_Click(object sender, EventArgs e)
        {
            if (_isTest)
            {
                ...
                {
                    FormRida_MilleraTest1 form = new FormRida_MilleraTest1(true);
                    form.Show();
                    this.Close();
                }
                else
                {
                    FormRida_MilleraTest2 form = new FormRida_MilleraTest2(true, countCorrectAnswer);
                    form.Show();
            ...
            {
                FormRida_MilleraTest1 form = new FormRida_MilleraTest1(false);
                form.Show();
                this.Close();
            }
        }
